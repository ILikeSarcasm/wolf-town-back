...
router.post('/building-game/participations', (req, res, next) => buildingGame.getParticipations(req.query.gameId, JSON.parse(decodeURIComponent(req.query.animalIds)), res));
...
router.post('/building-game/submit-again', (req, res, next) => buildingGame.submitAgain(req.query.gameId, JSON.parse(decodeURIComponent(req.query.animalIds)), req.query.password, res));
