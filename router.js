...
router.get('/building-game/participate', (req, res, next) => buildingGame.participateMany(req.query.game, JSON.parse(decodeURIComponent(req.query.participations)), req, res));
