...
router.get('/building-game/participations', (req, res, next) => buildingGame.getParticipations(req.query.gameId, JSON.parse(decodeURIComponent(req.query.animalIds)), res));
